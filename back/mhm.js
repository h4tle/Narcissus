...
var akkumulator = require('./models/akkumulator')
var bets = require('./models/bet')
var bet_types = require('./models/bet_type')
var leagues = require('./models/league')
var sports = require('./models/sport')
var teams = require('./models/team')
var tippers = require('./models/tipper')
...
function akkumulatorCreate(date, bet, tipper, stake, odds, akkumulator_result, cb) {
  authordetail = {date:date , bet:bet , tipper:tipper ,   }
